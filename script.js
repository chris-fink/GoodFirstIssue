//Clicking an option in the dropdown throws 'Uncaught ReferenceError: token is not defined' and just spins with no solution//
    ...
    function onSubmitButton() {
        ...
        //Uncaught TypeError: fetchQuery is not a function
        function fetchQuery() {

        }
        //Uncaught ReferenceError: token is not defined at makeQuery (script.js:345:13)
        function makeQuery(endCursor) {
            query = makeIssuesQuery(parameters.language, labels[labelIndex], endCursor);
            fetchQuery(searchIssuesQuery, query, handleData );
            //Something in this fetchQuery needs to be updated ^
        }
        ...
        //Uncaught ReferenceError: token is not defined at onSubmitButton (script.js:392:9)
        makeQuery();
        //Correct this ^
    }
    
    // var body declared locally to function fetchQuery; corrected to be declared universally
    var body = '';
    ...
    //Console err: Uncaught ReferenceError: token is not defined at fetchQuery (script.js:414:59)
        fetch('https://api.github.com/graphql',
        {
                ...
                headers: {
                        ...
                        //Something here needs to be corrected ^
                },
                body: body
